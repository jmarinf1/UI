...
private:
	...
	UPROPERTY(VisibleAnywhere, Category = "Swing Element", meta = (AllowPrivateAccess = "true"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Swing Element", meta = (AllowPrivateAccess = "true", ToolTip = "Animation montage played when swinging."))
	UAnimMontage* SwingMontage;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Swing Element", meta = (AllowPrivateAccess = "true", ToolTip = "Playback speed of the swing animation montage."))
	...
	UFUNCTION()
	void LaunchParabolicTo(float Time, FVector Start, FVector End);
	...
	UFUNCTION()
	bool CheckIfPlayerFacingBar(FVector RefLocation);
