...
void UFreeRoamCoverComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (IsInFreeCover)
	{
		OwnerCharacter->IsInFreeRoamCover = true;
		PullToCover();
		CheckCoverHeight();
...
void UFreeRoamCoverComponent::CheckCoverHeight()
{
	...
	OwnerCharacter->CoverHeightState = CoverHeightState;
}
...
void UFreeRoamCoverComponent::ResetCoverVariables()
{
	...
	Cast<UCharacterMovementComponent>(OwnerCharacter->GetMovementComponent())->MaxWalkSpeed = DefaultWalkSpeed;
	CoverHeightState = ECoverHeightState::NoCover;
	OwnerCharacter->CoverHeightState = CoverHeightState;
	OwnerCharacter->IsInFreeRoamCover = false;
}
