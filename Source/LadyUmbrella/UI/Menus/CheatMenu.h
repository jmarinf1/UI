...
UCLASS()
class LADYUMBRELLA_API UCheatMenu : public UMenu
{
	GENERATED_BODY()
	
	UPROPERTY(BlueprintReadWrite, Category = "Canvas", meta = (BindWidget, AllowPrivateAccess = "true"))
	UCanvasPanel* CheatsPanel;
