...
public:
	virtual void SubtractHealth(const float,EWeaponType DamageType) = 0;
	virtual void SubtractHealth(float Amount, EWeaponType DamageType, FVector LastDamageSourceLocation) 
	{
